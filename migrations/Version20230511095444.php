 ...
 */
final class Version20230511095444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, trick_id_id INT NOT NULL, user_id_id INT NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_9474526CB46B9EE8 (trick_id_id), INDEX IDX_9474526C9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
